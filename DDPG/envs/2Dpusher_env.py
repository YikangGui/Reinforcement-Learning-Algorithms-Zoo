...
class Pusher2d(gym.Env):
    ...
    # def apply_hindsight(self, states, actions, store_states, store_actions, store_next_states, store_rewards, store_dones):
    def apply_hindsight(self, states, actions, memory):
        ...
        for index, s in enumerate(states):
            ...
            if not goal_reach:
                ...
                if pass_first:
                    ...
                    pass_first = False
                    continue
                memory.store(last_state, actions[index - 1], r, s, not goal_reach)
                last_state = s
            else:
                break
